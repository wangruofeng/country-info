...
- 🌐 **多语言界面**：支持简体中文、繁体中文、英语、日语、韩语、泰语、马来语 7 种语言切换，语言偏好自动保存。国家名称取自 Unicode CLDR 官方本地化标注。
- 🔍 **多维搜索**：中文名（含别名，如“漂亮国”“巴铁”）、英文名、两位/三位国家码（CN / CHN）、ISO 数字码（156）、货币码（USD）、货币中文名（人民币）、电话区号（+86 / 86）、顶级域（.cn）均可命中，搜索随当前语言适配。
- 🗂️ **大洲分组**：亚洲、欧洲、北美洲、南美洲、非洲、大洋洲、南极洲七个分组浏览。
- 🗺️ **世界地图模式**：可在列表与交互式世界地图间切换；国家区域与内置数据关联，悬浮查看名称，点击即可打开详情，并支持放大、缩小、重置缩放、双指拖拽平移与捏合缩放。
